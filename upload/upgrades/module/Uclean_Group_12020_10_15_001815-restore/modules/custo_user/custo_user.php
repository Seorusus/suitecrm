...
class custo_user extends Person
{
    public $new_schema = true;
    public $module_dir = 'custo_user';
    public $object_name = 'custo_user';
    public $table_name = 'custo_user';
    ...
    public $matrats_2;
    public $kavrolin;
    public $kover_company;
    public $kover_home;
    public $min_him_clean;
    public $win_simple;
    public $win_rama;
    public $win_classic;
    public $win_french;
    public $win_arka;
    public $win_fasad_ground;
    public $banner;
    public $fasad;
    public $min_win_fasad;
    public $dishes;
    public $express;
