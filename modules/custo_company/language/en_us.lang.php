...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Контрагент Uclean_Group List',
  'LBL_MODULE_NAME' => 'Контрагент Uclean_Group',
  'LBL_MODULE_TITLE' => 'Контрагент Uclean_Group',
  'LBL_HOMEPAGE_TITLE' => 'My Контрагент Uclean_Group',
  'LNK_NEW_RECORD' => 'Create Контрагент Uclean_Group',
  'LNK_LIST' => 'View Контрагент Uclean_Group',
  'LNK_IMPORT_CUSTO_COMPANY_1' => 'Импорт Контрагент Uclean_Group',
  'LBL_SEARCH_FORM_TITLE' => 'Search Контрагент Uclean_Group',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_CUSTO_COMPANY_1_SUBPANEL_TITLE' => 'Контрагент Uclean_Group',
  'LBL_NEW_FORM_TITLE' => 'New Контрагент Uclean_Group',
