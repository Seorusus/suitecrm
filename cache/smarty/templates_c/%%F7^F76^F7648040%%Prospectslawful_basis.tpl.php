<?php /* Smarty version 2.6.31, created on 2020-12-01 11:30:46
         compiled from cache/modules/Import/Prospectslawful_basis.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'multienum_to_array', 'cache/modules/Import/Prospectslawful_basis.tpl', 7, false),array('function', 'html_options', 'cache/modules/Import/Prospectslawful_basis.tpl', 12, false),array('function', 'sugar_getimagepath', 'cache/modules/Import/Prospectslawful_basis.tpl', 41, false),array('modifier', 'count', 'cache/modules/Import/Prospectslawful_basis.tpl', 79, false),)), $this); ?>
...
<?php else: ?>
	...
	<?php $this->assign('field_options', $this->_tpl_vars['fields']['lawful_basis']['options']); ?>
	<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['lawful_basis']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
	...
	<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
...
_multiselect" value="true">
		...
		<select style='display:none' id="<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
"
		name="<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
[]"
		multiple="true" size='6' style="width:150" title='' tabindex="1"  
		...
		<input
	    id="<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
-input"
	    name="<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
-input"
	    size="60"
...
-image">
	    	...
	    	<button type="button"
	        id="btn-clear-<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
-input"
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
<?php echo '");
					    	var ret = [];
	...
	YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters","node-event-simulate", function (Y) {
	    ...
	    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
-input');
	    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
-image');
	    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['lawful_basis']['name']; ?>
');
