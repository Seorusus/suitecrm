<?php /* Smarty version 2.6.31, created on 2020-11-10 16:06:33
         compiled from cache/themes/SuiteP/modules/custo_contact/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 135, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 250, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 446, false),array('function', 'sugar_number_format', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 900, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 128, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 635, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 635, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 635, false),array('modifier', 'substr', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 1118, false),array('modifier', 'to_url', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 1120, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/custo_contact/DetailView.tpl', 1319, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='custo_contact'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='custo_contact'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='custo_contact'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='custo_contact'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['custo_contact_custo_company_1custo_company_idb']['value'] )): ?>
<?php ob_start(); ?>index.php?module=custo_company&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['custo_contact_custo_company_1custo_company_idb']['value']; ?>
...
"><?php endif; ?>
<span id="custo_contact_custo_company_1custo_company_idb" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['custo_contact_custo_company_1custo_company_idb']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['custo_contact_custo_company_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['custo_contact_custo_company_1custo_company_idb']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['partner_uclean_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['custo_user_id_c']['value'] )): ?>
<?php ob_start(); ?>index.php?module=custo_user&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['custo_user_id_c']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="custo_user_id_c" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['custo_user_id_c']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['partner_uclean_c']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['custo_user_id_c']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['ur_face_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['ur_face_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['ur_face_c']['name']; ?>
" value="$fields.ur_face_c.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['suurce_contact_uclean_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['suurce_contact_uclean_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['suurce_contact_uclean_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['suurce_contact_uclean_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['suurce_contact_uclean_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['suurce_contact_uclean_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['suurce_contact_uclean_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['suurce_contact_uclean_c']['options'][$this->_tpl_vars['fields']['suurce_contact_uclean_c']['value']]; ?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['calls_custo_contact_1calls_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Calls&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1calls_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="calls_custo_contact_1calls_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1calls_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['calls_custo_contact_1calls_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['prospects_custo_contact_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['prospects_custo_contact_1prospects_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Prospects&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['prospects_custo_contact_1prospects_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="prospects_custo_contact_1prospects_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['prospects_custo_contact_1prospects_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['prospects_custo_contact_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['prospects_custo_contact_1prospects_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['get_order_z_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php else: ?>
<?php if (strlen ( $this->_tpl_vars['fields']['get_order_z_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['get_order_z_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['get_order_z_c']['value']); ?>
<?php endif; ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['get_order_z_c']['name']; ?>
...
<?php if (! $this->_tpl_vars['fields']['not_order_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['not_order_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['not_order_c']['name']; ?>
" value="$fields.not_order_c.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['type_object_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['type_object_c']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['type_object_c']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html_entity_decode') : smarty_modifier_escape($_tmp, 'html_entity_decode')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['order_date_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php $this->assign('value', "{".($this->_tpl_vars['vardef']).".date_formatted_value"); ?> }
<?php else: ?>
<?php if (strlen ( $this->_tpl_vars['fields']['order_date_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['order_date_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['order_date_c']['value']); ?>
<?php endif; ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['order_date_c']['name']; ?>
"><?php echo $this->_tpl_vars['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['sum_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['sum_c']['name']; ?>
">
<?php echo smarty_function_sugar_number_format(array('var' => $this->_tpl_vars['fields']['sum_c']['value'],'precision' => 2), $this);?>
...
<?php if (! $this->_tpl_vars['fields']['feedback_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['feedback_c']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['feedback_c']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html_entity_decode') : smarty_modifier_escape($_tmp, 'html_entity_decode')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['lpr_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['lpr_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['lpr_c']['value']; ?>
</span>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['tel_lpr_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['tel_lpr_c']['value'] )): ?>
<?php $this->assign('phone_value', $this->_tpl_vars['fields']['tel_lpr_c']['value']); ?>
<?php echo smarty_function_sugar_phone(array('value' => $this->_tpl_vars['phone_value'],'usa_format' => '0'), $this);?>
...
<?php if (! $this->_tpl_vars['fields']['set_propose_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['set_propose_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['set_propose_c']['name']; ?>
" value="$fields.set_propose_c.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['sms_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['sms_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['sms_c']['name']; ?>
" value="$fields.sms_c.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
...
<?php if (! $this->_tpl_vars['fields']['site_tender_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['site_tender_c']['value']; ?>
...
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['site_tender_c']['name']; ?>
">
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS','module' => 'custo_contact'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_ADDRESS','module' => 'custo_contact'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
