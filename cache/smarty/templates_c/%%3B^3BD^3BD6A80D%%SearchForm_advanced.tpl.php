<?php /* Smarty version 2.6.31, created on 2020-11-16 09:52:49
         compiled from cache/themes/SuiteP/modules/custo_user/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/custo_user/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/custo_user/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/custo_user/SearchForm_advanced.tpl', 34, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/custo_user/SearchForm_advanced.tpl', 198, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/custo_user/SearchForm_advanced.tpl', 279, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='first_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_NAME','module' => 'custo_user'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='last_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LAST_NAME','module' => 'custo_user'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_by_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'custo_user'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='do_not_call_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DO_NOT_CALL','module' => 'custo_user'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='email_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'custo_user'), $this);?>
</label>
                            </div>
            <div class="form-item">
