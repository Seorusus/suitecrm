<?php /* Smarty version 2.6.31, created on 2020-11-15 23:36:23
         compiled from cache/themes/SuiteP/modules/Users/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 61, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 138, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 398, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1068, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1587, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 131, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1556, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1556, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Users/DetailView.tpl', 1556, false),)), $this); ?>
...
<input id="delete_button" title="Удалить" type="button" class="button" onclick="confirmDelete();" value="Удалить" //>
...
<li><input id="delete_button" title="Удалить" type="button" class="button" onclick="confirmDelete();" value="Удалить" //></li>
...
<?php if (! $this->_tpl_vars['fields']['sity_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['sity_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['sity_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sity_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['sity_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['sity_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sity_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['sity_c']['options'][$this->_tpl_vars['fields']['sity_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="custo_user_users_name" >

<?php if (! $this->_tpl_vars['fields']['custo_user_users_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['custo_user_userscusto_user_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=custo_user&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['custo_user_userscusto_user_ida']['value']; ?>
...
"><?php endif; ?>
<span id="custo_user_userscusto_user_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['custo_user_userscusto_user_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['custo_user_users_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['custo_user_userscusto_user_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="relate" field="custo_user_users_1_name" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['custo_user_users_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['custo_user_users_1custo_user_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=custo_user&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['custo_user_users_1custo_user_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="custo_user_users_1custo_user_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['custo_user_users_1custo_user_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['custo_user_users_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['custo_user_users_1custo_user_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit phone" type="phone" field="phone_mobile" colspan='3'>
