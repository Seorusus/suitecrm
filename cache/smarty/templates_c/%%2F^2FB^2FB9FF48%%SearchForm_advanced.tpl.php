...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='event_status_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_ACCEPT_STATUS','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['event_status_id_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['event_status_id_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['event_status_id_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['event_status_id_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['event_status_id_advanced']['name']; ?>
' size='30' 
