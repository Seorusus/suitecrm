<?php /* Smarty version 2.6.31, created on 2020-11-10 16:18:30
         compiled from cache/themes/SuiteP/modules/Calls/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 51, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 60, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 120, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 462, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 113, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 367, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 367, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Calls/DetailView.tpl', 367, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="type_call_list_c" >

<?php if (! $this->_tpl_vars['fields']['type_call_list_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['type_call_list_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['type_call_list_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['type_call_list_c']['options'][$this->_tpl_vars['fields']['type_call_list_c']['value']]; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="relate" field="calls_custo_contact_1_name" colspan='3'>

<?php if (! $this->_tpl_vars['fields']['calls_custo_contact_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['calls_custo_contact_1custo_contact_idb']['value'] )): ?>
<?php ob_start(); ?>index.php?module=custo_contact&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1custo_contact_idb']['value']; ?>
...
"><?php endif; ?>
<span id="calls_custo_contact_1custo_contact_idb" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1custo_contact_idb']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['calls_custo_contact_1custo_contact_idb']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
