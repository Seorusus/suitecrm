...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_city_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='sourse_contact_uclean_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SOURSE_CONTACT_UCLEAN','module' => 'Prospects'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'sourse_contact_uclean_c_advanced','name' => 'sourse_contact_uclean_c_advanced[]','options' => $this->_tpl_vars['fields']['sourse_contact_uclean_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['sourse_contact_uclean_c_advanced']['value']), $this);?>

<select id="sourse_contact_uclean_c_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#sourse_contact_uclean_c_advanced').multiSelect();</script>
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
