<?php /* Smarty version 2.6.31, created on 2020-11-11 10:04:58
         compiled from cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 38, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 952, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 1033, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Calls/SearchForm_advanced.tpl', 263, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_call_list_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE_CALL_LIST','module' => 'Calls'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'type_call_list_c_advanced','name' => 'type_call_list_c_advanced[]','options' => $this->_tpl_vars['fields']['type_call_list_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['type_call_list_c_advanced']['value']), $this);?>

<select id="type_call_list_c_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#type_call_list_c_advanced').multiSelect();</script>
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
...
<select id="direction_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#direction_advanced').multiSelect();</script>
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
...
<select id="status_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#status_advanced').multiSelect();</script>
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_parent_name_advanced\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name_advanced","parent_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_contact_name_advanced\']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_name_advanced","contact_id_advanced","contact_id_advanced","contact_id_advanced"],"required_list":["contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_company_calls_name_advanced\']={"form":"search_form","method":"query","modules":["custo_company"],"group":"or","field_list":["name","id"],"populate_list":["custo_company_calls_name_advanced","custo_company_callscusto_company_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_incom_incoming_marketing_calls_1_name_advanced\']={"form":"search_form","method":"query","modules":["incom_incoming_marketing"],"group":"or","field_list":["name","id"],"populate_list":["incom_incoming_marketing_calls_1_name_advanced","incom_incoming_marketing_calls_1incom_incoming_marketing_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_calls_custo_contact_1_name_advanced\']={"form":"search_form","method":"query","modules":["custo_contact"],"group":"or","field_list":["name","id"],"populate_list":["calls_custo_contact_1_name_advanced","calls_custo_contact_1custo_contact_idb_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_user_calls_1_name_advanced\']={"form":"search_form","method":"query","modules":["custo_user"],"group":"or","field_list":["name","id"],"populate_list":["custo_user_calls_1_name_advanced","custo_user_calls_1custo_user_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_leads_calls_1_name_advanced\']={"form":"search_form","method":"query","modules":["Leads"],"group":"or","field_list":["name","id"],"populate_list":["leads_calls_1_name_advanced","leads_calls_1leads_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};</script>'; ?>