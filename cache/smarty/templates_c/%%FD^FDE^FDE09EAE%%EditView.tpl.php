...
<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_UCLEAN','module' => 'Tasks'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['contact_uclean_c']['name']; ?>
...
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"custo_contact_id_c","name":"contact_uclean_c"}}'; ?>
, 
"single", 
true
...
<?php echo '\' );
addToValidate(\'EditView\', \'custo_user_tasks_1_name\', \'relate\', false,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'custo_contact_tasks_name\', \'relate\', false,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'custo_company_tasks_name\', \'relate\', false,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'contact_uclean_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_UCLEAN','module' => 'Tasks','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'custo_contact_id_c\', \'id\', false,\''; ?>
