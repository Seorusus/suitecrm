<?php /* Smarty version 2.6.31, created on 2020-11-24 10:23:30
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="sourse_contact_uclean_c" >

<?php if (! $this->_tpl_vars['fields']['sourse_contact_uclean_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['sourse_contact_uclean_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['sourse_contact_uclean_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sourse_contact_uclean_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['sourse_contact_uclean_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['sourse_contact_uclean_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['sourse_contact_uclean_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['sourse_contact_uclean_c']['options'][$this->_tpl_vars['fields']['sourse_contact_uclean_c']['value']]; ?>
