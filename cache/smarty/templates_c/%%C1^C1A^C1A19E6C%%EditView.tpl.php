...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TYPE_CALL_LIST">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE_CALL_LIST','module' => 'Calls'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="enum" field="type_call_list_c"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['type_call_list_c']['value'] ) && $this->_tpl_vars['fields']['type_call_list_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['type_call_list_c']['options'],'selected' => $this->_tpl_vars['fields']['type_call_list_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['type_call_list_c']['options'],'selected' => $this->_tpl_vars['fields']['type_call_list_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['type_call_list_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['type_call_list_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['type_call_list_c']['name']; ?>
');
...
<div class="col-xs-12 col-sm-2 label" data-label="LBL_CALLS_CUSTO_CONTACT_1_FROM_CUSTO_CONTACT_TITLE">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALLS_CUSTO_CONTACT_1_FROM_CUSTO_CONTACT_TITLE','module' => 'Calls'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="calls_custo_contact_1_name" colspan='3' >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<input type="text" name="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1custo_contact_idb']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"calls_custo_contact_1custo_contact_idb","name":"calls_custo_contact_1_name"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['calls_custo_contact_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php echo '\' );
addToValidate(\'EditView\', \'custo_company_calls_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTO_COMPANY_CALLS_FROM_CUSTO_COMPANY_TITLE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'incom_incoming_marketing_calls_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_INCOM_INCOMING_MARKETING_CALLS_1_FROM_INCOM_INCOMING_MARKETING_TITLE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'calls_custo_contact_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALLS_CUSTO_CONTACT_1_FROM_CUSTO_CONTACT_TITLE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'custo_user_calls_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTO_USER_CALLS_1_FROM_CUSTO_USER_TITLE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'leads_calls_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEADS_CALLS_1_FROM_LEADS_TITLE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'asterisk_user_ext_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_USER_EXT','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'asterisk_inbound_ext_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_INBOUND_EXT','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'asterisk_caller_id_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_CALLER_ID','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'type_call_list_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE_CALL_LIST','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'asterisk_call_id_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASTERISK_CALL_ID','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'calls_custo_contact_1_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Calls','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALLS_CUSTO_CONTACT_1_FROM_CUSTO_CONTACT_TITLE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\', \'calls_custo_contact_1custo_contact_idb\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_parent_name\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'EditView_calls_custo_contact_1_name\']={"form":"EditView","method":"query","modules":["custo_contact"],"group":"or","field_list":["name","id"],"populate_list":["calls_custo_contact_1_name","calls_custo_contact_1custo_contact_idb"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};</script>'; ?>
