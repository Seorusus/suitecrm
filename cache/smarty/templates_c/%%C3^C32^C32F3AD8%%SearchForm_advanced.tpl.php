<?php /* Smarty version 2.6.31, created on 2020-11-10 15:59:00
         compiled from cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 94, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 956, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 1037, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/custo_contact/SearchForm_advanced.tpl', 288, false),)), $this); ?>
...
<select id="sity_c_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#sity_c_advanced').multiSelect();</script>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_city_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['primary_address_city_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['primary_address_city_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['primary_address_city_advanced']['value']); ?>
<?php endif; ?>  
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['assigned_user_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'status_c_advanced','name' => 'status_c_advanced[]','options' => $this->_tpl_vars['fields']['status_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['status_c_advanced']['value']), $this);?>
...
<select id="status_c_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#status_c_advanced').multiSelect();</script>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_entered_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='order_date_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ORDER_DATE','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php $this->assign('id', $this->_tpl_vars['fields']['order_date_c_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['order_date_c_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['order_date_c_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_choice" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['order_date_c_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_order_date_c_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_order_date_c_advanced'] ) && ! empty ( $_REQUEST['order_date_c_advanced'] )): ?><?php echo $_REQUEST['order_date_c_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_order_date_c_advanced']; ?>
<?php endif; ?>' title=''   size="11" class="dateRangeInput">
    <button id="<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false;" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar"  alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span></button>
...
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['order_date_c_advanced']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_order_date_c_advanced']; ?>
' title=''  tabindex='' size="11" class="dateRangeInput">
    <button id="start_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span></button>
...
<input autocomplete="off" type="text" name="end_range_<?php echo $this->_tpl_vars['id']; ?>
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_order_date_c_advanced']; ?>
' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
    <button id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false" class="btn btn-danger">
        <span class="suitepicon suitepicon-module-calendar" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='get_order_z_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_GET_ORDER_Z','module' => 'custo_contact'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php $this->assign('id', $this->_tpl_vars['fields']['get_order_z_c_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['get_order_z_c_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['get_order_z_c_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_choice" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['get_order_z_c_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_get_order_z_c_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_get_order_z_c_advanced'] ) && ! empty ( $_REQUEST['get_order_z_c_advanced'] )): ?><?php echo $_REQUEST['get_order_z_c_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_get_order_z_c_advanced']; ?>
<?php endif; ?>' title=''   size="11" class="dateRangeInput">
    <button id="<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false;" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar"  alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span></button>
...
<div id="<?php echo $this->_tpl_vars['id']; ?>
_between_range_div" style="<?php if ($this->_tpl_vars['starting_choice'] == 'between'): ?>display:'';<?php else: ?>display:none;<?php endif; ?>">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['get_order_z_c_advanced']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_get_order_z_c_advanced']; ?>
' title=''  tabindex='' size="11" class="dateRangeInput">
    <button id="start_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span></button>
...
<input autocomplete="off" type="text" name="end_range_<?php echo $this->_tpl_vars['id']; ?>
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_get_order_z_c_advanced']; ?>
' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
    <button id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false" class="btn btn-danger">
        <span class="suitepicon suitepicon-module-calendar" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_prospects_custo_contact_1_name_advanced\']={"form":"search_form","method":"query","modules":["Prospects"],"group":"or","field_list":["name","id"],"populate_list":["prospects_custo_contact_1_name_advanced","prospects_custo_contact_1prospects_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_contact_campaigns_name_advanced\']={"form":"search_form","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["custo_contact_campaignscampaigns_ida_advanced","custo_contact_campaignscampaigns_ida_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_contact_incom_incoming_marketing_name_advanced\']={"form":"search_form","method":"query","modules":["incom_incoming_marketing"],"group":"or","field_list":["name","id"],"populate_list":["custo_contact_incom_incoming_marketing_name_advanced","custo_contf866rketing_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_contact_jjwg_maps_name_advanced\']={"form":"search_form","method":"query","modules":["jjwg_Maps"],"group":"or","field_list":["name","id"],"populate_list":["custo_contact_jjwg_maps_name_advanced","custo_contact_jjwg_mapsjjwg_maps_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_calls_custo_contact_1_name_advanced\']={"form":"search_form","method":"query","modules":["Calls"],"group":"or","field_list":["name","id"],"populate_list":["calls_custo_contact_1_name_advanced","calls_custo_contact_1calls_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_contact_users_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["custo_contact_users_name_advanced","custo_contact_usersusers_ida_advanced"],"required_list":["custo_contact_usersusers_ida"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_contact_custo_company_1_name_advanced\']={"form":"search_form","method":"query","modules":["custo_company"],"group":"or","field_list":["name","id"],"populate_list":["custo_contact_custo_company_1_name_advanced","custo_contact_custo_company_1custo_company_idb_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_contact_custo_contact_name_advanced\']={"form":"search_form","method":"query","modules":["custo_contact"],"group":"or","field_list":["name","id"],"populate_list":["custo_contact_custo_contact_name_advanced","custo_contact_custo_contactcusto_contact_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_custo_user_custo_contact_name_advanced\']={"form":"search_form","method":"query","modules":["custo_user"],"group":"or","field_list":["name","id"],"populate_list":["custo_user_custo_contact_name_advanced","custo_user_custo_contactcusto_user_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_partner_uclean_c_advanced\']={"form":"search_form","method":"query","modules":["custo_user"],"group":"or","field_list":["name","id"],"populate_list":["partner_uclean_c_advanced","custo_user_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};sqs_objects[\'search_form_company_c_advanced\']={"form":"search_form","method":"query","modules":["custo_company"],"group":"or","field_list":["name","id"],"populate_list":["company_c_advanced","custo_company_id_c_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\\u041d\\u0435 \\u0432\\u044b\\u0431\\u0440\\u0430\\u043d\\u043e"};</script>'; ?>