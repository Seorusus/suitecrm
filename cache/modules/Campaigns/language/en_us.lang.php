...
$mod_strings = array (
  ...
  'LBL_MODULE_NAME' => 'Outbound marketing',
  'LBL_MODULE_TITLE' => 'Campaigns: Home',
  'LBL_SEARCH_FORM_TITLE' => 'Outbound marketing Search',
  'LBL_LIST_FORM_TITLE' => 'Outbound marketing List',
  'LBL_NEWSLETTER_LIST_FORM_TITLE' => 'Newsletter List',
  'LBL_CAMPAIGN_NAME' => 'Name:',
  'LBL_CAMPAIGN' => 'Campaign:',
  'LBL_INVITEE' => 'Contacts',
  'LBL_LIST_CAMPAIGN_NAME' => 'Outbound marketing',
  ...
  'LNK_NEW_CAMPAIGN' => 'Create Outbound marketing (Classic)',
  'LNL_NEW_CAMPAIGN_WIZARD' => 'Create Campaign',
  'LNK_CAMPAIGN_LIST' => 'View Outbound marketing',
  'LNK_IMPORT_CAMPAIGNS' => 'Import Outbound marketing',
  ...
  'LBL_AOK_KNOWLEDGEBASE_CAMPAIGNS_1_FROM_AOK_KNOWLEDGEBASE_TITLE' => 'База знаний',
  'LBL_LEADS_CAMPAIGNS_1_FROM_LEADS_TITLE' => 'Предварит. контакты',
  'LBL_CUSTO_CONTACT_CAMPAIGNS_FROM_CUSTO_CONTACT_TITLE' => 'Контакт Uclean_Group',
  'LBL_CUSTO_COMPANY_CAMPAIGNS_FROM_CUSTO_COMPANY_TITLE' => 'Контрагент Uclean_Group',
  'LBL_CUSTO_USER_CAMPAIGNS_FROM_CUSTO_USER_TITLE' => 'Компания-партнер',
);