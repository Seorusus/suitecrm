...
$mod_strings = array (
  ...
  'LBL_CONTACTS_SUBPANEL_TITLE' => 'Контакт',
  ...
  'LBL_TYPE_CALL_LIST' => 'Тип входящего звонка',
  'LBL_CALLS_CONTACTS_1_FROM_CONTACTS_TITLE' => 'Контакты',
  'LBL_CUSTO_USER_CALLS_1_FROM_CUSTO_USER_TITLE' => 'Компания-партнер',
  'LBL_CUSTO_USER_CALLS_FROM_CUSTO_USER_TITLE' => 'Компания-партнер',
  'LBL_CUSTO_CONTACT_CALLS_FROM_CUSTO_CONTACT_TITLE' => 'Контакт Uclean_Group',
  'LBL_CALLS_AOK_KNOWLEDGEBASE_1_FROM_AOK_KNOWLEDGEBASE_TITLE' => 'Скрипт звонка',
  'LBL_LEADS_CALLS_1_FROM_LEADS_TITLE' => 'Предварит. контакты',
  'LBL_CUSTO_COMPANY_CALLS_FROM_CUSTO_COMPANY_TITLE' => 'Контрагент Uclean_Group',
  'LBL_INCOM_INCOMING_MARKETING_CALLS_1_FROM_INCOM_INCOMING_MARKETING_TITLE' => 'Входящий Маркетинг',
  'LBL_CALLS_CUSTO_CONTACT_1_FROM_CUSTO_CONTACT_TITLE' => 'Контакт Uclean_Group',
);