...
<table cellpadding=0 cellspacing=0> <tr><td><!--not_in_theme!-->Посетите www.suitecrm.com <img src=include/images/suitecrm_login.png style="margin-right: 5px;"> </td><td><a href="http://www.suitecrm.com/" target="_blank"><b>SuiteCRM</b></a></td></tr></table>',
  ...
  'LBL_COMPANY_CUSTO_COMPANY_ID' => 'Контрагент Uclean Group (связано с ID модуля )',
  'LBL_COMPANY' => 'Контрагент Uclean Group',
  'LBL_SITY' => 'Мiсто',
  'LBL_QUICKCREATE_PANEL1' => 'Новая панель 1',
  'LBL_CUSTO_USER_USERS_1_FROM_CUSTO_USER_TITLE' => 'Компания-партнер',
  'LBL_CUSTO_USER_USERS_FROM_CUSTO_USER_TITLE' => 'Компания-партнер',
  'LBL_CUSTO_CONTACT_USERS_FROM_CUSTO_CONTACT_TITLE' => 'Контакт Uclean_Group',
  'LBL_CUSTO_CONTACT_USERS_1_FROM_CUSTO_CONTACT_TITLE' => 'Контакт Uclean_Group',
  'LBL_CUSTO_COMPANY_USERS_FROM_CUSTO_COMPANY_TITLE' => 'Контрагент Uclean_Group',
);