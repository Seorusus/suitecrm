<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    'incom_incoming_marketing_contacts_1_name' => 
    array (
    ...
    'incom_incoming_marketing_contacts_1incom_incoming_marketing_ida' => 
    array (
    ...
    array (
      ...
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Contactsinbound_marketing_c',
      'custom_module' => 'Contacts',
    ),
    'last_name_1_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Для (Фамилия в род.падеже) Украiнська мова',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'last_name_1_c',
      'vname' => 'LBL_LAST_NAME_1',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactslast_name_1_c',
      'custom_module' => 'Contacts',
    ),
    'invitation_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Обращение',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'invitation_c',
      'vname' => 'LBL_INVITATION',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Выбрать обращение для ком.предложения',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'invitation_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactsinvitation_c',
      'custom_module' => 'Contacts',
    ),
    'dess_person_c' => 
    array (
    ...
    array (
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'other_marketing_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Contactsother_marketing_c',
      'custom_module' => 'Contacts',
    ),
    'deep_interest_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Особый интерес',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'deep_interest_c',
      'vname' => 'LBL_DEEP_INTEREST',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
    ...
    array (
      ...
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Contactsoutbound_marketing_c',
      'custom_module' => 'Contacts',
    ),
    'use_call_center_c' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Для (Имя в род.падеже) Украiнська мова',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'for_first_name_c',
      'vname' => 'LBL_FOR_FIRST_NAME',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '100',
      'size' => '20',
      'id' => 'Contactsfor_first_name_c',
      'custom_module' => 'Contacts',
    ),
    'outbound_marketing_quantity_c' => 
    array (
      'inline_edit' => '1',
      ...
      'vname' => 'LBL_OUTBOUND_MARKETING_QUANTITY',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => '10',
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsoutbound_marketing_quantity_c',
      'custom_module' => 'Contacts',
    ),
    'work_scheduler_c' => 
    array (
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactswork_scheduler_c',
      'custom_module' => 'Contacts',
    ),
    'for_person_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Выбрать обращение для...',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'for_person_c',
      'vname' => 'LBL_FOR_PERSON',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => 'pan',
      'no_default' => false,
      'comments' => 'Для ком.предложения',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'for_person_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsfor_person_c',
      'custom_module' => 'Contacts',
    ),
    'contact_status_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_INBOUND_MARKETING_QUANTITY',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => '10',
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsinbound_marketing_quantity_c',
      'custom_module' => 'Contacts',
    ),
  ),
  'indices' => 
