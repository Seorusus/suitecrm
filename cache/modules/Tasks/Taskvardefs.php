<?php 
 $GLOBALS["dictionary"]["Task"]=array (
  ...
  array (
    ...
    'custo_user_tasks_1custo_user_ida' => 
    array (
    ...
    'custo_contact_taskscusto_contact_ida' => 
    array (
    ...
    'custo_company_taskscusto_company_ida' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Контакт Uclean',
      'required' => false,
      'source' => 'non-db',
      'name' => 'contact_uclean_c',
      'vname' => 'LBL_CONTACT_UCLEAN',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id_name' => 'custo_contact_id_c',
      'ext2' => 'custo_contact',
      'module' => 'custo_contact',
      'rname' => 'name',
      'quicksearch' => 'enabled',
      'studio' => 'visible',
      'id' => 'Taskscontact_uclean_c',
      'custom_module' => 'Tasks',
    ),
    'custo_contact_id_c' => 
    array (
      ...
      'name' => 'custo_contact_id_c',
      'vname' => 'LBL_CONTACT_UCLEAN_CUSTO_CONTACT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
