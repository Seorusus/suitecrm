<?php 
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Входящий маркетинг',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'inbound_marketing_c',
      'vname' => 'LBL_INBOUND_MARKETING_C',
      'type' => 'multienum',
      'massupdate' => '1',
      'default' => '^hot_line^',
      'no_default' => false,
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'inbound_marketing_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Accountsinbound_marketing_c',
      'custom_module' => 'Accounts',
    ),
    'account_c' => 
    array (
      'labelValue' => 'Реквизиты юрлица',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'account_c',
      'vname' => 'LBL_ACCOUNT',
      ...
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Код ЄДРПОУ, р/счет, банк',
      'help' => '',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Лицо принимающее решение',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'dess_person_c',
      'vname' => 'LBL_DESS_PERSON_C',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountsdess_person_c',
      'custom_module' => 'Accounts',
    ),
    'other_marketing_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Другие услуги',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'other_marketing_c',
      'vname' => 'LBL_OTHER_MARKETING_C',
      'type' => 'multienum',
      'massupdate' => '1',
      'default' => '^^',
      'no_default' => false,
      ...
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Accountsother_marketing_c',
      'custom_module' => 'Accounts',
    ),
    'payment_method_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Способ оплаты',
      'required' => false,
      'source' => 'custom_fields',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountspayment_method_c',
      'custom_module' => 'Accounts',
    ),
    'facebook_com_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'facebook com',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'facebook_com_c',
      'vname' => 'LBL_FACEBOOK_COM',
      'type' => 'url',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'gen' => '',
      'link_target' => '_blank',
      'id' => 'Accountsfacebook_com_c',
      'custom_module' => 'Accounts',
    ),
    'descr_marketing_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Маркетинг описание',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'descr_marketing_c',
      'vname' => 'LBL_DESCR_MARKETING_C',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'rows' => '4',
      'cols' => '20',
      'id' => 'Accountsdescr_marketing_c',
      'custom_module' => 'Accounts',
    ),
    'twitter_com_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'twitter com',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'twitter_com_c',
      'vname' => 'LBL_TWITTER_COM',
      'type' => 'url',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Фамилия и инициалы на Украинском',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'signing_person_c',
      'vname' => 'LBL_SIGNING_PERSON',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Персона подписывающая договор',
      'help' => 'Персона подписывающая договор',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountssigning_person_c',
      'custom_module' => 'Accounts',
    ),
    'outbound_marketing_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Исходящий маркетинг',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'outbound_marketing_c',
      'vname' => 'LBL_OUTBOUND_MARKETING_C',
      'type' => 'multienum',
      'massupdate' => '1',
      'default' => NULL,
      'no_default' => false,
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'outbound_marketing_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Accountsoutbound_marketing_c',
      'custom_module' => 'Accounts',
    ),
    'use_call_center_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Колл-центр есть',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'use_call_center_c',
      'vname' => 'LBL_USE_CALL_CENTER_C',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Режим работы',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'work_scheduler_c',
      'vname' => 'LBL_WORK_SCHEDULER_C',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => '8',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'work_scheduler_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountswork_scheduler_c',
      'custom_module' => 'Accounts',
    ),
    'contragent_status_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Статус контрагента',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'contragent_status_c',
      'vname' => 'LBL_CONTRAGENT_STATUS',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => NULL,
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountscontragent_status_c',
      'custom_module' => 'Accounts',
    ),
    'outbound_marketing_quantity__c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Количество исходящих звонков',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'outbound_marketing_quantity__c',
      'vname' => 'LBL_OUTBOUND_MARKETING_QUANTITY_',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => '10',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'marketing_quantity_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsoutbound_marketing_quantity__c',
      'custom_module' => 'Accounts',
    ),
    'signing_person_im_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Фамилия и инициалы в именит.падеже',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'signing_person_im_c',
      'vname' => 'LBL_SIGNING_PERSON_IM',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Accountssigning_person_im_c',
      'custom_module' => 'Accounts',
    ),
    'inbound_marketing_quantity_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Количество входящих звонков',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'inbound_marketing_quantity_c',
      'vname' => 'LBL_INBOUND_MARKETING_QUANTITY_C',
      'type' => 'enum',
      'massupdate' => '1',
      'default' => '10',
      'no_default' => false,
      ...
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Accountsinbound_marketing_quantity_c',
      'custom_module' => 'Accounts',
    ),
    'oficial_name_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Юридическое название',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'oficial_name_c',
      'vname' => 'LBL_OFICIAL_NAME',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
