...
{else}
	...
	<span class="id-ff multiple">
	    <button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.campaign_type.name}-image"></button><button type="button"
	        ...
	        title="Clear"
	        onclick="SUGAR.clearRelateField(this.form, '{$fields.campaign_type.name}-input', '{$fields.campaign_type.name}');sync_{$fields.campaign_type.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
	</span>
