...
{if !$fields.custo_user_users_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.custo_user_userscusto_user_ida.value)}
{capture assign="detail_url"}index.php?module=custo_user&action=DetailView&record={$fields.custo_user_userscusto_user_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="custo_user_userscusto_user_ida" class="sugar_field" data-id-value="{$fields.custo_user_userscusto_user_ida.value}">{$fields.custo_user_users_name.value}</span>
{if !empty($fields.custo_user_userscusto_user_ida.value)}</a>{/if}
{/if}
...
{if !$fields.custo_user_users_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.custo_user_users_1custo_user_ida.value)}
{capture assign="detail_url"}index.php?module=custo_user&action=DetailView&record={$fields.custo_user_users_1custo_user_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="custo_user_users_1custo_user_ida" class="sugar_field" data-id-value="{$fields.custo_user_users_1custo_user_ida.value}">{$fields.custo_user_users_1_name.value}</span>
{if !empty($fields.custo_user_users_1custo_user_ida.value)}</a>{/if}
{/if}
