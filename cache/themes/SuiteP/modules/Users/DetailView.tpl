...
{assign var="phone_value" value=$fields.phone_work.value|trim}
{if $phone_value neq ''}
...
{assign var="phone_value" value=$fields.phone_mobile.value|trim}
{if $phone_value neq ''}
<img onclick="AsteriskIntegrationClickToCall('{$phone_value}', '{$module}', '{$id}');" src="modules/AsteriskIntegration/images/click_to_call.png" style="cursor: pointer; margin-right: 5px; height: 16px; width: 16px;"/>
{/if}
{sugar_phone value=$phone_value usa_format="0"}
...
{assign var="phone_value" value=$fields.phone_other.value|trim}
{if $phone_value neq ''}
<img onclick="AsteriskIntegrationClickToCall('{$phone_value}', '{$module}', '{$id}');" src="modules/AsteriskIntegration/images/click_to_call.png" style="cursor: pointer; margin-right: 5px; height: 16px; width: 16px;"/>
{/if}
{sugar_phone value=$phone_value usa_format="0"}
...
{assign var="phone_value" value=$fields.phone_fax.value|trim}
{if $phone_value neq ''}
<img onclick="AsteriskIntegrationClickToCall('{$phone_value}', '{$module}', '{$id}');" src="modules/AsteriskIntegration/images/click_to_call.png" style="cursor: pointer; margin-right: 5px; height: 16px; width: 16px;"/>
{/if}
{sugar_phone value=$phone_value usa_format="0"}
...
{assign var="phone_value" value=$fields.phone_home.value|trim}
{if $phone_value neq ''}
<img onclick="AsteriskIntegrationClickToCall('{$phone_value}', '{$module}', '{$id}');" src="modules/AsteriskIntegration/images/click_to_call.png" style="cursor: pointer; margin-right: 5px; height: 16px; width: 16px;"/>
{/if}
{sugar_phone value=$phone_value usa_format="0"}
