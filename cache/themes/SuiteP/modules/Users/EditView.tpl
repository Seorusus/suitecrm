...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SITY' module='Users'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTO_USER_USERS_FROM_CUSTO_USER_TITLE' module='Users'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.custo_user_users_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.custo_user_users_name.name}" size="" value="{$fields.custo_user_users_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.custo_user_users_name.id_name}" 
id="{$fields.custo_user_users_name.id_name}" 
value="{$fields.custo_user_userscusto_user_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.custo_user_users_name.name}" id="btn_{$fields.custo_user_users_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.custo_user_users_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"custo_user_userscusto_user_ida","name":"custo_user_users_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.custo_user_users_name.name}" id="btn_clr_{$fields.custo_user_users_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.custo_user_users_name.name}', '{$fields.custo_user_users_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.custo_user_users_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTO_USER_USERS_1_FROM_CUSTO_USER_TITLE' module='Users'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.custo_user_users_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.custo_user_users_1_name.name}" size="" value="{$fields.custo_user_users_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.custo_user_users_1_name.id_name}" 
id="{$fields.custo_user_users_1_name.id_name}" 
value="{$fields.custo_user_users_1custo_user_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.custo_user_users_1_name.name}" id="btn_{$fields.custo_user_users_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.custo_user_users_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"custo_user_users_1custo_user_ida","name":"custo_user_users_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.custo_user_users_1_name.name}" id="btn_clr_{$fields.custo_user_users_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.custo_user_users_1_name.name}', '{$fields.custo_user_users_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.custo_user_users_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'custo_user_users_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_USER_USERS_1_FROM_CUSTO_USER_TITLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'custo_user_users_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_USER_USERS_FROM_CUSTO_USER_TITLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'sity_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SITY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'company_c', 'relate', false,'{/literal}{sugar_translate label='LBL_COMPANY' module='Users' for_js=true}{literal}' );
...
addToValidate('EditView', 'custo_company_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_COMPANY_CUSTO_COMPANY_ID' module='Users' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'custo_user_users_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Users' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CUSTO_USER_USERS_1_FROM_CUSTO_USER_TITLE' module='Users' for_js=true}{literal}', 'custo_user_users_1custo_user_ida' );
addToValidateBinaryDependency('EditView', 'custo_user_users_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Users' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CUSTO_USER_USERS_FROM_CUSTO_USER_TITLE' module='Users' for_js=true}{literal}', 'custo_user_userscusto_user_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_custo_user_users_name']={"form":"EditView","method":"query","modules":["custo_user"],"group":"or","field_list":["name","id"],"populate_list":["custo_user_users_name","custo_user_userscusto_user_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};sqs_objects['EditView_custo_user_users_1_name']={"form":"EditView","method":"query","modules":["custo_user"],"group":"or","field_list":["name","id"],"populate_list":["custo_user_users_1_name","custo_user_users_1custo_user_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};sqs_objects['EditView_reports_to_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name","reports_to_id"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};</script>{/literal}
