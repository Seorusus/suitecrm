...
addToValidate('form_QuickCreate_Accounts', 'inbound_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_INBOUND_MARKETING_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'account_c', 'wysiwyg', false,'{/literal}{sugar_translate label='LBL_ACCOUNT' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'vk_com_c', 'url', false,'{/literal}{sugar_translate label='LBL_VK_COM' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'dess_person_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DESS_PERSON_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'other_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_OTHER_MARKETING_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'payment_method_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PAYMENT_METHOD' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'facebook_com_c', 'url', false,'{/literal}{sugar_translate label='LBL_FACEBOOK_COM' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'descr_marketing_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESCR_MARKETING_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'twitter_com_c', 'url', false,'{/literal}{sugar_translate label='LBL_TWITTER_COM' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'signing_person_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SIGNING_PERSON' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'outbound_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_OUTBOUND_MARKETING_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'use_call_center_c', 'bool', false,'{/literal}{sugar_translate label='LBL_USE_CALL_CENTER_C' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'working_hours_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_WORKING_HOURS' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'ok_ru_c', 'url', false,'{/literal}{sugar_translate label='LBL_OK_RU' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'work_scheduler_c', 'enum', false,'{/literal}{sugar_translate label='LBL_WORK_SCHEDULER_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'contragent_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CONTRAGENT_STATUS' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'outbound_marketing_quantity__c', 'enum', false,'{/literal}{sugar_translate label='LBL_OUTBOUND_MARKETING_QUANTITY_' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'signing_person_im_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SIGNING_PERSON_IM' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'inbound_marketing_quantity_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INBOUND_MARKETING_QUANTITY_C' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'oficial_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_OFICIAL_NAME' module='Accounts' for_js=true}{literal}' );
