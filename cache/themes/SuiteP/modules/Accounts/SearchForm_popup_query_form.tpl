...
{html_options id='account_type_advanced' name='account_type_advanced[]' id='account_type_advanced' options=$fields.account_type_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.account_type_advanced.value}
<select id="account_type_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#account_type_advanced').multiSelect();</script>
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
...
{html_options id='industry_advanced' name='industry_advanced[]' id='industry_advanced' options=$fields.industry_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.industry_advanced.value}
<select id="industry_advanced_hide" style="width: 150"></select><script type="text/javascript">$('#industry_advanced').multiSelect();</script>
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
