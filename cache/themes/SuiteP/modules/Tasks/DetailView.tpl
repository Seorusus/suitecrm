...
{if !$fields.contact_uclean_c.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.custo_contact_id_c.value)}
{capture assign="detail_url"}index.php?module=custo_contact&action=DetailView&record={$fields.custo_contact_id_c.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="custo_contact_id_c" class="sugar_field" data-id-value="{$fields.custo_contact_id_c.value}">{$fields.contact_uclean_c.value}</span>
{if !empty($fields.custo_contact_id_c.value)}</a>{/if}
{/if}
