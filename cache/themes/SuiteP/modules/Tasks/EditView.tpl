...
<script>var disabledModules={"AOS_Contracts":"AOS_Contracts","AOS_Invoices":"AOS_Invoices","AOS_Products":"AOS_Products","AOS_Quotes":"AOS_Quotes","Bugs":"Bugs","Opportunities":"Opportunities","Project":"Project","ProjectTask":"ProjectTask"};</script>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_CONTACT_UCLEAN">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CONTACT_UCLEAN' module='Tasks'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="contact_uclean_c"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.contact_uclean_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.contact_uclean_c.name}" size="" value="{$fields.contact_uclean_c.value}" title='' autocomplete="off"  	 >
...
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.contact_uclean_c.name}" id="btn_{$fields.contact_uclean_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"custo_contact_id_c","name":"contact_uclean_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.contact_uclean_c.name}" id="btn_clr_{$fields.contact_uclean_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
...
addToValidate('EditView', 'custo_user_tasks_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_USER_TASKS_1_FROM_CUSTO_USER_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'custo_contact_tasks_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_CONTACT_TASKS_FROM_CUSTO_CONTACT_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'custo_company_tasks_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_COMPANY_TASKS_FROM_CUSTO_COMPANY_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'contact_uclean_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACT_UCLEAN' module='Tasks' for_js=true}{literal}' );
addToValidate('EditView', 'custo_contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACT_UCLEAN_CUSTO_CONTACT_ID' module='Tasks' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'contact_uclean_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Tasks' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CONTACT_UCLEAN' module='Tasks' for_js=true}{literal}', 'custo_contact_id_c' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_parent_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};sqs_objects['EditView_contact_uclean_c']={"form":"EditView","method":"query","modules":["custo_contact"],"group":"or","field_list":["name","id"],"populate_list":["contact_uclean_c","custo_contact_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};sqs_objects['EditView_contact_name']={"form":"EditView","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_name","contact_id","contact_id","contact_id"],"required_list":["contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};</script>{/literal}
