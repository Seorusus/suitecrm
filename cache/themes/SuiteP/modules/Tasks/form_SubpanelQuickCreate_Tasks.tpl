...
addToValidate('form_SubpanelQuickCreate_Tasks', 'custo_user_tasks_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_USER_TASKS_1_FROM_CUSTO_USER_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'custo_contact_tasks_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_CONTACT_TASKS_FROM_CUSTO_CONTACT_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'custo_company_tasks_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_COMPANY_TASKS_FROM_CUSTO_COMPANY_TITLE' module='Tasks' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'contact_uclean_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACT_UCLEAN' module='Tasks' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Tasks', 'custo_contact_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CONTACT_UCLEAN_CUSTO_CONTACT_ID' module='Tasks' for_js=true}{literal}' );
