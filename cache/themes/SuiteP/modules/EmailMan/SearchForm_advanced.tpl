...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='campaign_name_advanced'>{sugar_translate label='LBL_LIST_CAMPAIGN' module='EmailMan'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.campaign_name_advanced.value) <= 0}
{assign var="value" value=$fields.campaign_name_advanced.default_value }
{else}
{assign var="value" value=$fields.campaign_name_advanced.value }
{/if}  
<input type='text' name='{$fields.campaign_name_advanced.name}' 
    id='{$fields.campaign_name_advanced.name}' size='30' 
    maxlength='50' 
    value='{$value}' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='to_name_advanced'>{sugar_translate label='LBL_LIST_RECIPIENT_NAME' module='EmailMan'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.to_name_advanced.value) <= 0}
{assign var="value" value=$fields.to_name_advanced.default_value }
{else}
{assign var="value" value=$fields.to_name_advanced.value }
{/if}  
<input type='text' name='{$fields.to_name_advanced.name}' 
    id='{$fields.to_name_advanced.name}' size='30' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='to_email_advanced'>{sugar_translate label='LBL_LIST_RECIPIENT_EMAIL' module='EmailMan'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.to_email_advanced.value) <= 0}
{assign var="value" value=$fields.to_email_advanced.default_value }
{else}
{assign var="value" value=$fields.to_email_advanced.value }
{/if}  
<input type='text' name='{$fields.to_email_advanced.name}' 
    id='{$fields.to_email_advanced.name}' size='30' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='current_user_only_advanced'>{sugar_translate label='LBL_CURRENT_USER_FILTER' module='EmailMan'}</label>
                            </div>
            <div class="form-item">
