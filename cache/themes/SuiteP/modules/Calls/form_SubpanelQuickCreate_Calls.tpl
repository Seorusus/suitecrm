...
addToValidate('form_SubpanelQuickCreate_Calls', 'custo_company_calls_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_COMPANY_CALLS_FROM_CUSTO_COMPANY_TITLE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'incom_incoming_marketing_calls_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_INCOM_INCOMING_MARKETING_CALLS_1_FROM_INCOM_INCOMING_MARKETING_TITLE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'calls_custo_contact_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CALLS_CUSTO_CONTACT_1_FROM_CUSTO_CONTACT_TITLE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'custo_user_calls_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CUSTO_USER_CALLS_1_FROM_CUSTO_USER_TITLE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'leads_calls_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_LEADS_CALLS_1_FROM_LEADS_TITLE' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'asterisk_user_ext_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_USER_EXT' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'asterisk_inbound_ext_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_INBOUND_EXT' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'asterisk_caller_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_CALLER_ID' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'type_call_list_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TYPE_CALL_LIST' module='Calls' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Calls', 'asterisk_call_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ASTERISK_CALL_ID' module='Calls' for_js=true}{literal}' );
