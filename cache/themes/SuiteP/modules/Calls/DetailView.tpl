...
{if !$fields.type_call_list_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.type_call_list_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.type_call_list_c.name}" value="{ $fields.type_call_list_c.options }">
{ $fields.type_call_list_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.type_call_list_c.name}" value="{ $fields.type_call_list_c.value }">
{ $fields.type_call_list_c.options[$fields.type_call_list_c.value]}
{/if}
{/if}
...
{if !empty($fields.calls_custo_contact_1custo_contact_idb.value)}
{capture assign="detail_url"}index.php?module=custo_contact&action=DetailView&record={$fields.calls_custo_contact_1custo_contact_idb.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="calls_custo_contact_1custo_contact_idb" class="sugar_field" data-id-value="{$fields.calls_custo_contact_1custo_contact_idb.value}">{$fields.calls_custo_contact_1_name.value}</span>
{if !empty($fields.calls_custo_contact_1custo_contact_idb.value)}</a>{/if}
{/if}
