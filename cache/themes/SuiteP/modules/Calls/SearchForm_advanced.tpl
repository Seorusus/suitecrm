...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='type_call_list_c_advanced'>{sugar_translate label='LBL_TYPE_CALL_LIST' module='Calls'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='type_call_list_c_advanced' name='type_call_list_c_advanced[]' id='type_call_list_c_advanced' options=$fields.type_call_list_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.type_call_list_c_advanced.value}
...
{html_options id='direction_advanced' name='direction_advanced[]' id='direction_advanced' options=$fields.direction_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.direction_advanced.value}
...
{html_options id='status_advanced' name='status_advanced[]' id='status_advanced' options=$fields.status_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.status_advanced.value}
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_start_advanced }' title=''  tabindex='' size="11" class="dateRangeInput">
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_date_end_advanced }' title=''  tabindex='' size="11" class="dateRangeInput">
    <button id="start_range_{$id}_trigger" type="button" onclick="return false" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "start_range_{$id}",
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='date_modified_advanced'>{sugar_translate label='LBL_DATE_MODIFIED' module='Calls'}</label>
                            </div>
            <div class="form-item">
