...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='last_name_1_c_advanced'>{sugar_translate label='LBL_LAST_NAME_1' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.last_name_1_c_advanced.value) <= 0}
{assign var="value" value=$fields.last_name_1_c_advanced.default_value }
{else}
{assign var="value" value=$fields.last_name_1_c_advanced.value }
{/if}  
<input type='text' name='{$fields.last_name_1_c_advanced.name}' 
    id='{$fields.last_name_1_c_advanced.name}' size='30' 
    maxlength='255' 
