...
{if !$fields.calls_contacts_1_name.hidden}
{/if}
...
{if !$fields.incom_incoming_marketing_contacts_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.incom_incoming_marketing_contacts_1incom_incoming_marketing_ida.value)}
{capture assign="detail_url"}index.php?module=incom_incoming_marketing&action=DetailView&record={$fields.incom_incoming_marketing_contacts_1incom_incoming_marketing_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="incom_incoming_marketing_contacts_1incom_incoming_marketing_ida" class="sugar_field" data-id-value="{$fields.incom_incoming_marketing_contacts_1incom_incoming_marketing_ida.value}">{$fields.incom_incoming_marketing_contacts_1_name.value}</span>
{if !empty($fields.incom_incoming_marketing_contacts_1incom_incoming_marketing_ida.value)}</a>{/if}
{/if}
...
{if !$fields.deep_interest_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if}
<input type="checkbox" class="checkbox" name="{$fields.deep_interest_c.name}" id="{$fields.deep_interest_c.name}" value="$fields.deep_interest_c.value" disabled="true" {$checked}>
{/if}
...
{if !$fields.contact_status_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.contact_status_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.contact_status_c.name}" value="{ $fields.contact_status_c.options }">
{ $fields.contact_status_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.contact_status_c.name}" value="{ $fields.contact_status_c.value }">
{ $fields.contact_status_c.options[$fields.contact_status_c.value]}
{/if}
{/if}
...
{if !$fields.work_scheduler_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.work_scheduler_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.work_scheduler_c.name}" value="{ $fields.work_scheduler_c.options }">
{ $fields.work_scheduler_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.work_scheduler_c.name}" value="{ $fields.work_scheduler_c.value }">
{ $fields.work_scheduler_c.options[$fields.work_scheduler_c.value]}
{/if}
{/if}
...
{if !$fields.inbound_marketing_c.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.inbound_marketing_c.value) && ($fields.inbound_marketing_c.value != '^^')}
<input type="hidden" class="sugar_field" id="{$fields.inbound_marketing_c.name}" value="{$fields.inbound_marketing_c.value}">
{multienum_to_array string=$fields.inbound_marketing_c.value assign="vals"}
{foreach from=$vals item=item}
<li style="margin-left:10px;">{ $fields.inbound_marketing_c.options.$item }</li>
{/foreach}
{/if}
{/if}
...
{if !$fields.inbound_marketing_quantity_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.inbound_marketing_quantity_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.inbound_marketing_quantity_c.name}" value="{ $fields.inbound_marketing_quantity_c.options }">
{ $fields.inbound_marketing_quantity_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.inbound_marketing_quantity_c.name}" value="{ $fields.inbound_marketing_quantity_c.value }">
{ $fields.inbound_marketing_quantity_c.options[$fields.inbound_marketing_quantity_c.value]}
{/if}
{/if}
...
{if !$fields.outbound_marketing_c.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.outbound_marketing_c.value) && ($fields.outbound_marketing_c.value != '^^')}
<input type="hidden" class="sugar_field" id="{$fields.outbound_marketing_c.name}" value="{$fields.outbound_marketing_c.value}">
{multienum_to_array string=$fields.outbound_marketing_c.value assign="vals"}
{foreach from=$vals item=item}
<li style="margin-left:10px;">{ $fields.outbound_marketing_c.options.$item }</li>
{/foreach}
{/if}
{/if}
...
{if !$fields.outbound_marketing_quantity_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.outbound_marketing_quantity_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.outbound_marketing_quantity_c.name}" value="{ $fields.outbound_marketing_quantity_c.options }">
{ $fields.outbound_marketing_quantity_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.outbound_marketing_quantity_c.name}" value="{ $fields.outbound_marketing_quantity_c.value }">
{ $fields.outbound_marketing_quantity_c.options[$fields.outbound_marketing_quantity_c.value]}
{/if}
{/if}
...
{if !$fields.other_marketing_c.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.other_marketing_c.value) && ($fields.other_marketing_c.value != '^^')}
<input type="hidden" class="sugar_field" id="{$fields.other_marketing_c.name}" value="{$fields.other_marketing_c.value}">
{multienum_to_array string=$fields.other_marketing_c.value assign="vals"}
{foreach from=$vals item=item}
<li style="margin-left:10px;">{ $fields.other_marketing_c.options.$item }</li>
{/foreach}
{/if}
{/if}
...
{if !$fields.dess_person_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.dess_person_c.name|escape:'html'|url2html|nl2br}">{$fields.dess_person_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{if !$fields.use_call_center_c.hidden}
{counter name="panelFieldCount" print=false}
...
{assign var="checked" value=""}
{/if}
<input type="checkbox" class="checkbox" name="{$fields.use_call_center_c.name}" id="{$fields.use_call_center_c.name}" value="$fields.use_call_center_c.value" disabled="true" {$checked}>
{/if}
...
{if !$fields.descr_marketing_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.descr_marketing_c.name|escape:'html'|url2html|nl2br}">{$fields.descr_marketing_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{sugar_translate label='LBL_DETAILVIEW_PANEL2' module='Contacts'}
</div>
</a>
</div>
...
{if !$fields.for_first_name_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.for_first_name_c.name}">{$fields.for_first_name_c.value}</span>
{/if}
...
{if !$fields.last_name_1_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.last_name_1_c.name}">{$fields.last_name_1_c.value}</span>
{/if}
...
{if !$fields.invitation_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.invitation_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.invitation_c.name}" value="{ $fields.invitation_c.options }">
{ $fields.invitation_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.invitation_c.name}" value="{ $fields.invitation_c.value }">
{ $fields.invitation_c.options[$fields.invitation_c.value]}
{/if}
{/if}
...
{if !$fields.for_person_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.for_person_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.for_person_c.name}" value="{ $fields.for_person_c.options }">
{ $fields.for_person_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.for_person_c.name}" value="{ $fields.for_person_c.value }">
{ $fields.for_person_c.options[$fields.for_person_c.value]}
{/if}
{/if}
