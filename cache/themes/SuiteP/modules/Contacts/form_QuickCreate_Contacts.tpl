...
addToValidate('form_QuickCreate_Contacts', 'incom_incoming_marketing_contacts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_INCOM_INCOMING_MARKETING_CONTACTS_1_FROM_INCOM_INCOMING_MARKETING_TITLE' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'inbound_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_INBOUND_MARKETING' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'last_name_1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_NAME_1' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'invitation_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INVITATION' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'dess_person_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESS_PERSON' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'other_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_OTHER_MARKETING' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'deep_interest_c', 'bool', false,'{/literal}{sugar_translate label='LBL_DEEP_INTEREST' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'descr_marketing_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESCR_MARKETING' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'outbound_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_OUTBOUND_MARKETING' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'use_call_center_c', 'bool', false,'{/literal}{sugar_translate label='LBL_USE_CALL_CENTER' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'for_first_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FOR_FIRST_NAME' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'outbound_marketing_quantity_c', 'enum', false,'{/literal}{sugar_translate label='LBL_OUTBOUND_MARKETING_QUANTITY' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'work_scheduler_c', 'enum', false,'{/literal}{sugar_translate label='LBL_WORK_SCHEDULER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'for_person_c', 'enum', false,'{/literal}{sugar_translate label='LBL_FOR_PERSON' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'contact_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CONTACT_STATUS' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'inbound_marketing_quantity_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INBOUND_MARKETING_QUANTITY' module='Contacts' for_js=true}{literal}' );
