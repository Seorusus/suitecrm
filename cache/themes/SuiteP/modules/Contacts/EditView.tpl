...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_INCOM_INCOMING_MARKETING_CONTACTS_1_FROM_INCOM_INCOMING_MARKETING_TITLE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.incom_incoming_marketing_contacts_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.incom_incoming_marketing_contacts_1_name.name}" size="" value="{$fields.incom_incoming_marketing_contacts_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.incom_incoming_marketing_contacts_1_name.id_name}" 
id="{$fields.incom_incoming_marketing_contacts_1_name.id_name}" 
value="{$fields.incom_incoming_marketing_contacts_1incom_incoming_marketing_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.incom_incoming_marketing_contacts_1_name.name}" id="btn_{$fields.incom_incoming_marketing_contacts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.incom_incoming_marketing_contacts_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"incom_incoming_marketing_contacts_1incom_incoming_marketing_ida","name":"incom_incoming_marketing_contacts_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.incom_incoming_marketing_contacts_1_name.name}" id="btn_clr_{$fields.incom_incoming_marketing_contacts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.incom_incoming_marketing_contacts_1_name.name}', '{$fields.incom_incoming_marketing_contacts_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.incom_incoming_marketing_contacts_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DEEP_INTEREST' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.contact_status_c.name}" 
id="{$fields.contact_status_c.name}" 
title=''       
>
{if isset($fields.contact_status_c.value) && $fields.contact_status_c.value != ''}
{html_options options=$fields.contact_status_c.options selected=$fields.contact_status_c.value}
{else}
{html_options options=$fields.contact_status_c.options selected=$fields.contact_status_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.contact_status_c.options }
{capture name="field_val"}{$fields.contact_status_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.contact_status_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.contact_status_c.name}" 
id="{$fields.contact_status_c.name}" 
title=''          
>
{if isset($fields.contact_status_c.value) && $fields.contact_status_c.value != ''}
...
<input
id="{$fields.contact_status_c.name}-input"
name="{$fields.contact_status_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.contact_status_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.contact_status_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.contact_status_c.name}-input', '{$fields.contact_status_c.name}');sync_{$fields.contact_status_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.contact_status_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.contact_status_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.contact_status_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.contact_status_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.contact_status_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.contact_status_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.contact_status_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_WORK_SCHEDULER' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.work_scheduler_c.name}" 
id="{$fields.work_scheduler_c.name}" 
title=''       
>
{if isset($fields.work_scheduler_c.value) && $fields.work_scheduler_c.value != ''}
{html_options options=$fields.work_scheduler_c.options selected=$fields.work_scheduler_c.value}
{else}
{html_options options=$fields.work_scheduler_c.options selected=$fields.work_scheduler_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.work_scheduler_c.options }
{capture name="field_val"}{$fields.work_scheduler_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.work_scheduler_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.work_scheduler_c.name}" 
id="{$fields.work_scheduler_c.name}" 
title=''          
>
{if isset($fields.work_scheduler_c.value) && $fields.work_scheduler_c.value != ''}
...
<input
id="{$fields.work_scheduler_c.name}-input"
name="{$fields.work_scheduler_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.work_scheduler_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.work_scheduler_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.work_scheduler_c.name}-input', '{$fields.work_scheduler_c.name}');sync_{$fields.work_scheduler_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.work_scheduler_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.work_scheduler_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.work_scheduler_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.work_scheduler_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.work_scheduler_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.work_scheduler_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.work_scheduler_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_INBOUND_MARKETING' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<input type="hidden" id="{$fields.inbound_marketing_c.name}_multiselect"
name="{$fields.inbound_marketing_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.inbound_marketing_c.value default=$fields.inbound_marketing_c.default assign="values"}
<select id="{$fields.inbound_marketing_c.name}"
name="{$fields.inbound_marketing_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.inbound_marketing_c.options selected=$values}
</select>
{else}
{assign var="field_options" value=$fields.inbound_marketing_c.options }
{capture name="field_val"}{$fields.inbound_marketing_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.inbound_marketing_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<input type="hidden" id="{$fields.inbound_marketing_c.name}_multiselect"
name="{$fields.inbound_marketing_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.inbound_marketing_c.value default=$fields.inbound_marketing_c.default assign="values"}
<select style='display:none' id="{$fields.inbound_marketing_c.name}"
name="{$fields.inbound_marketing_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.inbound_marketing_c.options selected=$values}
...
<input
id="{$fields.inbound_marketing_c.name}-input"
name="{$fields.inbound_marketing_c.name}-input"
size="60"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button">
<img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.inbound_marketing_c.name}-image">
</button>
<button type="button"
id="btn-clear-{$fields.inbound_marketing_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.inbound_marketing_c.name}-input', '{$fields.inbound_marketing_c.name};');SUGAR.AutoComplete.{$ac_key}.inputNode.updateHidden()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
		...
		YUI().use('datasource', 'datasource-jsonschema', function (Y) {
					SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.ds = new Y.DataSource.Function({
					    source: function (request) {
					    	var selectElem = document.getElementById("{/literal}{$fields.inbound_marketing_c.name}{literal}");
					    	var ret = [];
					    	for (i=0;i<selectElem.options.length;i++)
					    		if (!(selectElem.options[i].value=='' && selectElem.options[i].innerHTML==''))
					    			ret.push({'key':selectElem.options[i].value,'text':selectElem.options[i].innerHTML});
	...
	YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters","node-event-simulate", function (Y) {
	    ...
	    SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.inbound_marketing_c.name}-input');
	    SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.inbound_marketing_c.name}-image');
	    SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.inbound_marketing_c.name}');
		...
		if({/literal}SUGAR.AutoComplete.{$ac_key}.minQLen{literal} == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("{/literal}{$fields.inbound_marketing_c.name}-input{literal}"))
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_INBOUND_MARKETING_QUANTITY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.inbound_marketing_quantity_c.name}" 
id="{$fields.inbound_marketing_quantity_c.name}" 
title=''       
>
{if isset($fields.inbound_marketing_quantity_c.value) && $fields.inbound_marketing_quantity_c.value != ''}
{html_options options=$fields.inbound_marketing_quantity_c.options selected=$fields.inbound_marketing_quantity_c.value}
{else}
{html_options options=$fields.inbound_marketing_quantity_c.options selected=$fields.inbound_marketing_quantity_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.inbound_marketing_quantity_c.options }
{capture name="field_val"}{$fields.inbound_marketing_quantity_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.inbound_marketing_quantity_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.inbound_marketing_quantity_c.name}" 
id="{$fields.inbound_marketing_quantity_c.name}" 
title=''          
>
{if isset($fields.inbound_marketing_quantity_c.value) && $fields.inbound_marketing_quantity_c.value != ''}
...
<input
id="{$fields.inbound_marketing_quantity_c.name}-input"
name="{$fields.inbound_marketing_quantity_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.inbound_marketing_quantity_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.inbound_marketing_quantity_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.inbound_marketing_quantity_c.name}-input', '{$fields.inbound_marketing_quantity_c.name}');sync_{$fields.inbound_marketing_quantity_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.inbound_marketing_quantity_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.inbound_marketing_quantity_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.inbound_marketing_quantity_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.inbound_marketing_quantity_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.inbound_marketing_quantity_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.inbound_marketing_quantity_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.inbound_marketing_quantity_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OUTBOUND_MARKETING' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<input type="hidden" id="{$fields.outbound_marketing_c.name}_multiselect"
name="{$fields.outbound_marketing_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.outbound_marketing_c.value default=$fields.outbound_marketing_c.default assign="values"}
<select id="{$fields.outbound_marketing_c.name}"
name="{$fields.outbound_marketing_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.outbound_marketing_c.options selected=$values}
</select>
{else}
{assign var="field_options" value=$fields.outbound_marketing_c.options }
{capture name="field_val"}{$fields.outbound_marketing_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.outbound_marketing_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<input type="hidden" id="{$fields.outbound_marketing_c.name}_multiselect"
name="{$fields.outbound_marketing_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.outbound_marketing_c.value default=$fields.outbound_marketing_c.default assign="values"}
<select style='display:none' id="{$fields.outbound_marketing_c.name}"
name="{$fields.outbound_marketing_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.outbound_marketing_c.options selected=$values}
...
<input
id="{$fields.outbound_marketing_c.name}-input"
name="{$fields.outbound_marketing_c.name}-input"
size="60"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button">
<img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.outbound_marketing_c.name}-image">
</button>
<button type="button"
id="btn-clear-{$fields.outbound_marketing_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.outbound_marketing_c.name}-input', '{$fields.outbound_marketing_c.name};');SUGAR.AutoComplete.{$ac_key}.inputNode.updateHidden()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
		...
		YUI().use('datasource', 'datasource-jsonschema', function (Y) {
					SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.ds = new Y.DataSource.Function({
					    source: function (request) {
					    	var selectElem = document.getElementById("{/literal}{$fields.outbound_marketing_c.name}{literal}");
					    	var ret = [];
					    	for (i=0;i<selectElem.options.length;i++)
					    		if (!(selectElem.options[i].value=='' && selectElem.options[i].innerHTML==''))
					    			ret.push({'key':selectElem.options[i].value,'text':selectElem.options[i].innerHTML});
	...
	YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters","node-event-simulate", function (Y) {
	    ...
	    SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.outbound_marketing_c.name}-input');
	    SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.outbound_marketing_c.name}-image');
	    SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.outbound_marketing_c.name}');
		...
		if({/literal}SUGAR.AutoComplete.{$ac_key}.minQLen{literal} == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("{/literal}{$fields.outbound_marketing_c.name}-input{literal}"))
		    		SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.updateText();
		    	setTimeout(updateTextOnInterval,100);
		    }
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OUTBOUND_MARKETING_QUANTITY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.outbound_marketing_quantity_c.name}" 
id="{$fields.outbound_marketing_quantity_c.name}" 
title=''       
>
{if isset($fields.outbound_marketing_quantity_c.value) && $fields.outbound_marketing_quantity_c.value != ''}
{html_options options=$fields.outbound_marketing_quantity_c.options selected=$fields.outbound_marketing_quantity_c.value}
{else}
{html_options options=$fields.outbound_marketing_quantity_c.options selected=$fields.outbound_marketing_quantity_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.outbound_marketing_quantity_c.options }
{capture name="field_val"}{$fields.outbound_marketing_quantity_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.outbound_marketing_quantity_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.outbound_marketing_quantity_c.name}" 
id="{$fields.outbound_marketing_quantity_c.name}" 
title=''          
>
{if isset($fields.outbound_marketing_quantity_c.value) && $fields.outbound_marketing_quantity_c.value != ''}
...
<input
id="{$fields.outbound_marketing_quantity_c.name}-input"
name="{$fields.outbound_marketing_quantity_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.outbound_marketing_quantity_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.outbound_marketing_quantity_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.outbound_marketing_quantity_c.name}-input', '{$fields.outbound_marketing_quantity_c.name}');sync_{$fields.outbound_marketing_quantity_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.outbound_marketing_quantity_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.outbound_marketing_quantity_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.outbound_marketing_quantity_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.outbound_marketing_quantity_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.outbound_marketing_quantity_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.outbound_marketing_quantity_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.outbound_marketing_quantity_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_OTHER_MARKETING' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<input type="hidden" id="{$fields.other_marketing_c.name}_multiselect"
name="{$fields.other_marketing_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.other_marketing_c.value default=$fields.other_marketing_c.default assign="values"}
<select id="{$fields.other_marketing_c.name}"
name="{$fields.other_marketing_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.other_marketing_c.options selected=$values}
</select>
{else}
{assign var="field_options" value=$fields.other_marketing_c.options }
{capture name="field_val"}{$fields.other_marketing_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.other_marketing_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<input type="hidden" id="{$fields.other_marketing_c.name}_multiselect"
name="{$fields.other_marketing_c.name}_multiselect" value="true">
{multienum_to_array string=$fields.other_marketing_c.value default=$fields.other_marketing_c.default assign="values"}
<select style='display:none' id="{$fields.other_marketing_c.name}"
name="{$fields.other_marketing_c.name}[]"
multiple="true" size='6' style="width:150" title='' tabindex="0"  
>
{html_options options=$fields.other_marketing_c.options selected=$values}
...
<input
id="{$fields.other_marketing_c.name}-input"
name="{$fields.other_marketing_c.name}-input"
size="60"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button">
<img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.other_marketing_c.name}-image">
</button>
<button type="button"
id="btn-clear-{$fields.other_marketing_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.other_marketing_c.name}-input', '{$fields.other_marketing_c.name};');SUGAR.AutoComplete.{$ac_key}.inputNode.updateHidden()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
		...
		YUI().use('datasource', 'datasource-jsonschema', function (Y) {
					SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.ds = new Y.DataSource.Function({
					    source: function (request) {
					    	var selectElem = document.getElementById("{/literal}{$fields.other_marketing_c.name}{literal}");
					    	var ret = [];
					    	for (i=0;i<selectElem.options.length;i++)
					    		if (!(selectElem.options[i].value=='' && selectElem.options[i].innerHTML==''))
					    			ret.push({'key':selectElem.options[i].value,'text':selectElem.options[i].innerHTML});
	...
	YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters","node-event-simulate", function (Y) {
	    ...
	    SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.other_marketing_c.name}-input');
	    SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.other_marketing_c.name}-image');
	    SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.other_marketing_c.name}');
		...
		if({/literal}SUGAR.AutoComplete.{$ac_key}.minQLen{literal} == 0){
		    ...
		    function updateTextOnInterval(){
		    	if (document.activeElement != document.getElementById("{/literal}{$fields.other_marketing_c.name}-input{literal}"))
		    		SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.updateText();
		    	setTimeout(updateTextOnInterval,100);
		    }
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DESS_PERSON' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_USE_CALL_CENTER' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCR_MARKETING' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_INVITATION' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.invitation_c.name}" 
id="{$fields.invitation_c.name}" 
title=''       
>
{if isset($fields.invitation_c.value) && $fields.invitation_c.value != ''}
{html_options options=$fields.invitation_c.options selected=$fields.invitation_c.value}
{else}
{html_options options=$fields.invitation_c.options selected=$fields.invitation_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.invitation_c.options }
{capture name="field_val"}{$fields.invitation_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.invitation_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.invitation_c.name}" 
id="{$fields.invitation_c.name}" 
title=''          
>
{if isset($fields.invitation_c.value) && $fields.invitation_c.value != ''}
...
<input
id="{$fields.invitation_c.name}-input"
name="{$fields.invitation_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.invitation_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.invitation_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.invitation_c.name}-input', '{$fields.invitation_c.name}');sync_{$fields.invitation_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.invitation_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.invitation_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.invitation_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.invitation_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.invitation_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.invitation_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.invitation_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_FOR_PERSON' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.for_person_c.name}" 
id="{$fields.for_person_c.name}" 
title=''       
>
{if isset($fields.for_person_c.value) && $fields.for_person_c.value != ''}
{html_options options=$fields.for_person_c.options selected=$fields.for_person_c.value}
{else}
{html_options options=$fields.for_person_c.options selected=$fields.for_person_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.for_person_c.options }
{capture name="field_val"}{$fields.for_person_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.for_person_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.for_person_c.name}" 
id="{$fields.for_person_c.name}" 
title=''          
>
{if isset($fields.for_person_c.value) && $fields.for_person_c.value != ''}
...
<input
id="{$fields.for_person_c.name}-input"
name="{$fields.for_person_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.for_person_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.for_person_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.for_person_c.name}-input', '{$fields.for_person_c.name}');sync_{$fields.for_person_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.for_person_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.for_person_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.for_person_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.for_person_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.for_person_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.for_person_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.for_person_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_FOR_FIRST_NAME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_LAST_NAME_1' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
addToValidate('EditView', 'incom_incoming_marketing_contacts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_INCOM_INCOMING_MARKETING_CONTACTS_1_FROM_INCOM_INCOMING_MARKETING_TITLE' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'inbound_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_INBOUND_MARKETING' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'last_name_1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LAST_NAME_1' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'invitation_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INVITATION' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'dess_person_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESS_PERSON' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'other_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_OTHER_MARKETING' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'deep_interest_c', 'bool', false,'{/literal}{sugar_translate label='LBL_DEEP_INTEREST' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'descr_marketing_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESCR_MARKETING' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'outbound_marketing_c[]', 'multienum', false,'{/literal}{sugar_translate label='LBL_OUTBOUND_MARKETING' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'use_call_center_c', 'bool', false,'{/literal}{sugar_translate label='LBL_USE_CALL_CENTER' module='Contacts' for_js=true}{literal}' );
...
addToValidate('EditView', 'for_first_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FOR_FIRST_NAME' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'outbound_marketing_quantity_c', 'enum', false,'{/literal}{sugar_translate label='LBL_OUTBOUND_MARKETING_QUANTITY' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'work_scheduler_c', 'enum', false,'{/literal}{sugar_translate label='LBL_WORK_SCHEDULER' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'for_person_c', 'enum', false,'{/literal}{sugar_translate label='LBL_FOR_PERSON' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'contact_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CONTACT_STATUS' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'inbound_marketing_quantity_c', 'enum', false,'{/literal}{sugar_translate label='LBL_INBOUND_MARKETING_QUANTITY' module='Contacts' for_js=true}{literal}' );
