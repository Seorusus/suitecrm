...
{if !$fields.sourse_contact_uclean_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.sourse_contact_uclean_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.sourse_contact_uclean_c.name}" value="{ $fields.sourse_contact_uclean_c.options }">
{ $fields.sourse_contact_uclean_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.sourse_contact_uclean_c.name}" value="{ $fields.sourse_contact_uclean_c.value }">
{ $fields.sourse_contact_uclean_c.options[$fields.sourse_contact_uclean_c.value]}
{/if}
{/if}
