...
<select id="{$fields.do_not_call_advanced.name}" name="{$fields.do_not_call_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_city_advanced'>{sugar_translate label='LBL_PRIMARY_ADDRESS_CITY' module='Prospects'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.address_state_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='sourse_contact_uclean_c_advanced'>{sugar_translate label='LBL_SOURSE_CONTACT_UCLEAN' module='Prospects'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='sourse_contact_uclean_c_advanced' name='sourse_contact_uclean_c_advanced[]' id='sourse_contact_uclean_c_advanced' options=$fields.sourse_contact_uclean_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.sourse_contact_uclean_c_advanced.value}
