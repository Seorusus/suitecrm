...
addToValidate('form_QuickCreate_Prospects', 'sourse_contact_uclean_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SOURSE_CONTACT_UCLEAN' module='Prospects' for_js=true}{literal}' );
