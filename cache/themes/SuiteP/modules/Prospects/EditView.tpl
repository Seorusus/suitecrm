...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_SOURSE_CONTACT_UCLEAN' module='Prospects'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.sourse_contact_uclean_c.name}" 
id="{$fields.sourse_contact_uclean_c.name}" 
title=''       
>
{if isset($fields.sourse_contact_uclean_c.value) && $fields.sourse_contact_uclean_c.value != ''}
{html_options options=$fields.sourse_contact_uclean_c.options selected=$fields.sourse_contact_uclean_c.value}
{else}
{html_options options=$fields.sourse_contact_uclean_c.options selected=$fields.sourse_contact_uclean_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.sourse_contact_uclean_c.options }
{capture name="field_val"}{$fields.sourse_contact_uclean_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.sourse_contact_uclean_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.sourse_contact_uclean_c.name}" 
id="{$fields.sourse_contact_uclean_c.name}" 
title=''          
>
{if isset($fields.sourse_contact_uclean_c.value) && $fields.sourse_contact_uclean_c.value != ''}
...
<input
id="{$fields.sourse_contact_uclean_c.name}-input"
name="{$fields.sourse_contact_uclean_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.sourse_contact_uclean_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.sourse_contact_uclean_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.sourse_contact_uclean_c.name}-input', '{$fields.sourse_contact_uclean_c.name}');sync_{$fields.sourse_contact_uclean_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.sourse_contact_uclean_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.sourse_contact_uclean_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.sourse_contact_uclean_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.sourse_contact_uclean_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.sourse_contact_uclean_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.sourse_contact_uclean_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.sourse_contact_uclean_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
addToValidate('EditView', 'lawful_basis', 'multienum', false,'{/literal}{sugar_translate label='LBL_LAWFUL_BASIS' module='Prospects' for_js=true}{literal}' );
addToValidate('EditView', 'date_reviewed', 'date', false,'{/literal}{sugar_translate label='LBL_DATE_REVIEWED' module='Prospects' for_js=true}{literal}' );
addToValidate('EditView', 'lawful_basis_source', 'enum', false,'{/literal}{sugar_translate label='LBL_LAWFUL_BASIS_SOURCE' module='Prospects' for_js=true}{literal}' );
...
addToValidate('EditView', 'sourse_contact_uclean_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SOURSE_CONTACT_UCLEAN' module='Prospects' for_js=true}{literal}' );
