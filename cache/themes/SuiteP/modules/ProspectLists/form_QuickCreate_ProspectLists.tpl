...
<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="button" onclick="toggleDisplay('addform');return false;" name="ProspectLists_popup_cancel_button" type="submit"id="ProspectLists_popup_cancel_button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
{if $showVCRControl}
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.list_type.name}-input', '{$fields.list_type.name}');sync_{$fields.list_type.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
...
{minify}
<label for="domain_name"><div id="domain_label_div">{$MOD.LBL_DOMAIN}</div></label>
...
{counter name="panelFieldCount"  print=false}
<div id="domain_name_div"><input tabindex="0"  name="domain_name" id="domain_name" maxlength="255" type="text" value="{$fields.domain_name.value}"></div>
</div>
