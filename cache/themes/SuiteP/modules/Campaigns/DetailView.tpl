...
{capture name="label" assign="label"}{sugar_translate label='LBL_AOK_KNOWLEDGEBASE_CAMPAIGNS_1_FROM_AOK_KNOWLEDGEBASE_TITLE' module='Campaigns'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.aok_knowledgebase_campaigns_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.aok_knowledgebase_campaigns_1aok_knowledgebase_ida.value)}
{capture assign="detail_url"}index.php?module=AOK_KnowledgeBase&action=DetailView&record={$fields.aok_knowledgebase_campaigns_1aok_knowledgebase_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="aok_knowledgebase_campaigns_1aok_knowledgebase_ida" class="sugar_field" data-id-value="{$fields.aok_knowledgebase_campaigns_1aok_knowledgebase_ida.value}">{$fields.aok_knowledgebase_campaigns_1_name.value}</span>
{if !empty($fields.aok_knowledgebase_campaigns_1aok_knowledgebase_ida.value)}</a>{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_LEADS_CAMPAIGNS_1_FROM_LEADS_TITLE' module='Campaigns'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.leads_campaigns_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.leads_campaigns_1leads_ida.value)}
{capture assign="detail_url"}index.php?module=Leads&action=DetailView&record={$fields.leads_campaigns_1leads_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="leads_campaigns_1leads_ida" class="sugar_field" data-id-value="{$fields.leads_campaigns_1leads_ida.value}">{$fields.leads_campaigns_1_name.value}</span>
{if !empty($fields.leads_campaigns_1leads_ida.value)}</a>{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTO_USER_CAMPAIGNS_FROM_CUSTO_USER_TITLE' module='Campaigns'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.custo_user_campaigns_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.custo_user_campaignscusto_user_ida.value)}
{capture assign="detail_url"}index.php?module=custo_user&action=DetailView&record={$fields.custo_user_campaignscusto_user_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="custo_user_campaignscusto_user_ida" class="sugar_field" data-id-value="{$fields.custo_user_campaignscusto_user_ida.value}">{$fields.custo_user_campaigns_name.value}</span>
{if !empty($fields.custo_user_campaignscusto_user_ida.value)}</a>{/if}
{/if}
