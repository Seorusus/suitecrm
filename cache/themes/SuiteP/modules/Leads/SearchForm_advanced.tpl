...
{html_options name='created_by_advanced[]' id='created_by_advanced' options=$user_options size="6" style="width: 150px" multiple="1" selected=$fields.created_by_advanced.value}
...
<input type='text' name='{$fields.address_street_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_state_advanced'>{sugar_translate label='LBL_PRIMARY_ADDRESS_STATE' module='Leads'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.primary_address_state_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='primary_address_city_advanced'>{sugar_translate label='LBL_PRIMARY_ADDRESS_CITY' module='Leads'}</label>
                            </div>
            <div class="form-item">
