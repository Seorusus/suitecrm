...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_2' module='Leads'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.email_2_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.email_2_c.value) <= 0}
{assign var="value" value=$fields.email_2_c.default_value }
{else}
{assign var="value" value=$fields.email_2_c.value }
{/if} 
<span class="sugar_field" id="{$fields.email_2_c.name}">{$fields.email_2_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_3' module='Leads'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.email_3_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.email_3_c.value) <= 0}
{assign var="value" value=$fields.email_3_c.default_value }
{else}
{assign var="value" value=$fields.email_3_c.value }
{/if} 
<span class="sugar_field" id="{$fields.email_3_c.name}">{$fields.email_3_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_4' module='Leads'}{/capture}
{$label|strip_semicolon}:
</div>
...
{/if} 
<span class="sugar_field" id="{$fields.email_4_c.name}">{$fields.email_4_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_EMAIL_5' module='Leads'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.email_5_c.hidden}
{counter name="panelFieldCount" print=false}

{if strlen($fields.email_5_c.value) <= 0}
{assign var="value" value=$fields.email_5_c.default_value }
{else}
{assign var="value" value=$fields.email_5_c.value }
{/if} 
<span class="sugar_field" id="{$fields.email_5_c.name}">{$fields.email_5_c.value}</span>
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INCOM_INCOMING_MARKETING_LEADS_FROM_INCOM_INCOMING_MARKETING_TITLE' module='Leads'}{/capture}
{$label|strip_semicolon}:
</div>
...
{if !$fields.incom_incoming_marketing_leads_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.incom_incoming_marketing_leadsincom_incoming_marketing_ida.value)}
{capture assign="detail_url"}index.php?module=incom_incoming_marketing&action=DetailView&record={$fields.incom_incoming_marketing_leadsincom_incoming_marketing_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="incom_incoming_marketing_leadsincom_incoming_marketing_ida" class="sugar_field" data-id-value="{$fields.incom_incoming_marketing_leadsincom_incoming_marketing_ida.value}">{$fields.incom_incoming_marketing_leads_name.value}</span>
{if !empty($fields.incom_incoming_marketing_leadsincom_incoming_marketing_ida.value)}</a>{/if}
{/if}
