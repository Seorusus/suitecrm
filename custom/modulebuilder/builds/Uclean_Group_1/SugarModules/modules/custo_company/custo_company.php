...
class custo_company extends Company
{
    public $new_schema = true;
    public $module_dir = 'custo_company';
    public $object_name = 'custo_company';
    public $table_name = 'custo_company';
