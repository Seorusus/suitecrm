...
$mod_strings = array (
  ...
  'LBL_CONSENT' => 'Consent',
  'LBL_LIST_FORM_TITLE' => 'Контакт Кастом List',
  'LBL_MODULE_NAME' => 'Контакт Кастом',
  'LBL_MODULE_TITLE' => 'Контакт Кастом',
  'LBL_HOMEPAGE_TITLE' => 'My Контакт Кастом',
  'LNK_NEW_RECORD' => 'Create Контакт Кастом',
  'LNK_LIST' => 'View Контакт Кастом',
  'LNK_IMPORT_CUSTO_CONTACT' => 'Импорт Контакт Кастом',
  'LBL_SEARCH_FORM_TITLE' => 'Search Контакт Кастом',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
  'LBL_CUSTO_CONTACT_SUBPANEL_TITLE' => 'Контакт Кастом',
  'LBL_NEW_FORM_TITLE' => 'New Контакт Кастом',
);