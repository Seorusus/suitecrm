...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Контакт Кастом Список',
  'LBL_MODULE_NAME' => 'Контакт Кастом',
  'LBL_MODULE_TITLE' => 'Контакт Кастом',
  'LBL_HOMEPAGE_TITLE' => 'Мой Контакт Кастом',
  'LNK_NEW_RECORD' => 'Создать Контакт Кастом',
  'LNK_LIST' => 'Отображать Контакт Кастом',
  'LNK_IMPORT_CUSTO_CONTACT' => 'Импорт Контакт Кастом',
  'LBL_SEARCH_FORM_TITLE' => 'Найти Контакт Кастом',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Просмотр истории',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Мероприятия',
  'LBL_CUSTO_CONTACT_SUBPANEL_TITLE' => 'Контакт Кастом',
  'LBL_NEW_FORM_TITLE' => 'Новый Контакт Кастом',
);