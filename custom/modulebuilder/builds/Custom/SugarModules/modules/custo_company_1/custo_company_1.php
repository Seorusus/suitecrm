...
class custo_company_1 extends Company
{
    public $new_schema = true;
    public $module_dir = 'custo_company_1';
    public $object_name = 'custo_company_1';
    public $table_name = 'custo_company_1';
