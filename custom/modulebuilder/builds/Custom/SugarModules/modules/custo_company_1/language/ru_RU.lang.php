...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Контрагент Кастом Список',
  'LBL_MODULE_NAME' => 'Контрагент Кастом',
  'LBL_MODULE_TITLE' => 'Контрагент Кастом',
  'LBL_HOMEPAGE_TITLE' => 'Мой Контрагент Кастом',
  'LNK_NEW_RECORD' => 'Создать Контрагент Кастом',
  'LNK_LIST' => 'Отображать Контрагент Кастом',
  'LNK_IMPORT_CUSTO_COMPANY_1' => 'Импорт Контрагент Кастом',
  'LBL_SEARCH_FORM_TITLE' => 'Найти Контрагент Кастом',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Просмотр истории',
  'LBL_CUSTO_COMPANY_1_SUBPANEL_TITLE' => 'Контрагент Кастом',
  'LBL_NEW_FORM_TITLE' => 'Новый Контрагент Кастом',
);