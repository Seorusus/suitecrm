...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Контрагент Кастом List',
  'LBL_MODULE_NAME' => 'Контрагент Кастом',
  'LBL_MODULE_TITLE' => 'Контрагент Кастом',
  'LBL_HOMEPAGE_TITLE' => 'My Контрагент Кастом',
  'LNK_NEW_RECORD' => 'Create Контрагент Кастом',
  'LNK_LIST' => 'View Контрагент Кастом',
  'LNK_IMPORT_CUSTO_COMPANY_1' => 'Импорт Контрагент Кастом',
  'LBL_SEARCH_FORM_TITLE' => 'Search Контрагент Кастом',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_CUSTO_COMPANY_1_SUBPANEL_TITLE' => 'Контрагент Кастом',
  'LBL_NEW_FORM_TITLE' => 'New Контрагент Кастом',
);