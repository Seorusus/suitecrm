...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Компания-партнер Список',
  'LBL_MODULE_NAME' => 'Компания-партнер',
  'LBL_MODULE_TITLE' => 'Компания-партнер',
  'LBL_HOMEPAGE_TITLE' => 'Мой Компания-партнер',
  'LNK_NEW_RECORD' => 'Создать Компания-партнер',
  'LNK_LIST' => 'Отображать Компания-партнер',
  'LNK_IMPORT_CUSTO_USER' => 'Импорт Компания-партнер',
  'LBL_SEARCH_FORM_TITLE' => 'Найти Компания-партнер',
