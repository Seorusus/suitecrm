...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Контрагент Uclean_Group Список',
  'LBL_MODULE_NAME' => 'Контрагент Uclean_Group',
  'LBL_MODULE_TITLE' => 'Контрагент Uclean_Group',
  'LBL_HOMEPAGE_TITLE' => 'Мой Контрагент Uclean_Group',
  'LNK_NEW_RECORD' => 'Создать Контрагент Uclean_Group',
  'LNK_LIST' => 'Отображать Контрагент Uclean_Group',
  'LNK_IMPORT_CUSTO_COMPANY_1' => 'Импорт Контрагент Uclean_Group',
  'LBL_SEARCH_FORM_TITLE' => 'Найти Контрагент Uclean_Group',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Просмотр истории',
  'LBL_CUSTO_COMPANY_1_SUBPANEL_TITLE' => 'Контрагент Uclean_Group',
  'LBL_NEW_FORM_TITLE' => 'Новый Контрагент Uclean_Group',
  'LNK_IMPORT_CUSTO_COMPANY' => 'Импорт Контрагент Uclean_Group',
  'LBL_CUSTO_COMPANY_SUBPANEL_TITLE' => 'Контрагент Uclean_Group',
);